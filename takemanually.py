    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "/Users/shairinmeraj/Desktop/pro/repos/Attendance-Management-system-using-face-recognition/Attendance/"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"/Users/shairinmeraj/Desktop/pro/repos/Attendance-Management-system-using-face-recognition/Attendance"'
                )
